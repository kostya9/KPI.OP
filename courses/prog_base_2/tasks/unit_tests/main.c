...
#include <cmocka.h>
#include "int_list.h"
static void get_size__CreatedListAddedTwoElements__SizeIsTwo(void ** state)
{
...
static void get_size__CreatedList__SizeIsNull(void ** state)
{
    int_list_t * list = int_list_new();
...
int main(void)
{
    const struct CMUnitTest tests[] =
    {
        ...
        cmocka_unit_test(get_size__CreatedList__SizeIsNull),
        cmocka_unit_test(get_size__CreatedListAddedTwoElements__SizeIsTwo)
    };
